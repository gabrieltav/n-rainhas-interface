/**
 *  Um gerador de UI do Chess que pega um objeto da classe Engine e visualiza as etapas desse mecanismo.
 *  Motores disponíveis : NQueensBacktrackingEngine, NQueensGeneticEngine
...
class ChessUI {
  ...
  async loadQueenIcon() {
    try {
      this.queenIcon = await this.loadImage("src/images/queen.png");
    } catch (e) {
